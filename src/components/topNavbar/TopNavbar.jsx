...
function TopNavbar() {
    ...
    return (
        ...
        bg-cyan-400 fixed w-full top-0  z-40 '>
            <div className="left">

                {/* logo  */}
                <div className="flex justify-center mb-2">
                    <img className=" w-14 mt-2 " src="https://cdn-icons-png.flaticon.com/128/10061/10061684.png" alt="" />
                </div>
            </div>
            <div className="right bg-cyan-200 py-1">
